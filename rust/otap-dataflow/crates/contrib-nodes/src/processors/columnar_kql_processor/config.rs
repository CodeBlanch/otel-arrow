...
pub struct ColumnarKqlProcessorConfig {
...
#[cfg(test)]
mod tests {
    use super::super::processor::ColumnarKqlProcessor;
    ...
    fn test_config_parsing() {
        ...
        let config: ColumnarKqlProcessorConfig = serde_json::from_value(config_json).unwrap();
    ...
    fn test_config_parsing_with_bridge_options() {
        ...
        let bridge_options = ColumnarKqlProcessor::parse_bridge_options(&config.bridge_options);
    ...
    fn test_processor_creation() {
        ...
        let config = ColumnarKqlProcessorConfig {
